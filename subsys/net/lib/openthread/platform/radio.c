...
enum pending_events {
	...
	PENDING_EVENT_RX_FAILED, /* The RX failed - this is usually normal */
			...
			void *event_params)
{
	...
	case IEEE802154_EVENT_RX_FAILED:
		if (sState == OT_RADIO_STATE_RECEIVE) {
			...
			case IEEE802154_RX_FAIL_INVALID_FSC:
				tx_rx_result = OT_ERROR_FCS;
				break;

			case IEEE802154_RX_FAIL_ADDR_FILTERED:
				tx_rx_result = OT_ERROR_DESTINATION_ADDRESS_FILTERED;
				break;

			case IEEE802154_RX_FAIL_FAILED:
			default:
